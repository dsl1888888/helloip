...
//	            String bashCommand = "kill -9" + ip;
	...
	public static void openudpPort(String ip, String port) {
		try {
			String bashCommand = "iptables -I INPUT -s "+ip+" -p udp -m udp --dport "+port+" -j ACCEPT";
//	            String bashCommand = "kill -9" + ip;
	...
	public static void openAllProtocolPort(String ip, String port) {
		try {
			String bashCommand = "iptables -I INPUT -s "+ip+" -p all -m all --dport "+port+" -j ACCEPT";
//	            String bashCommand = "kill -9" + ip;
